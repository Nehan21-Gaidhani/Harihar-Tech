...
export default function Services() {
  return (
    <div>
      {/* What We Do Section */}
      <section className="bg-white pt-[10rem] pb-[2.5rem] px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-200 " style={{ boxShadow: '0 0 12px rgba(0,0,0,0.15)' }}>
